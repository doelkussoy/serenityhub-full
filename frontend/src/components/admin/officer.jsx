          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="text-left border-b border-slate-100">
                ...
                <th className="px-4 md:px-6 py-3.5 text-xs font-semibold text-slate-500 uppercase tracking-wider hidden md:table-cell">Email</th>
              ...
              {loading ? (
                ...
                officerData.map((item, index) => (
                  <tr key={item._id || index} className="hover:bg-slate-50/70 transition-colors duration-150 group">
                    ...
                    <td className="px-4 md:px-6 py-4">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-slate-500 lowercase md:hidden mt-0.5">{item.email}</p>
                    ...
                    <td className="px-4 md:px-6 py-4 hidden md:table-cell text-slate-600 font-medium lowercase">
                      {item.email}
                    </td>
                    <td className="px-4 md:px-6 py-4 hidden sm:table-cell">
                      {item.unitWork ? (
                    ...
                    <td className="px-4 md:px-6 py-4 text-right">
                      <div className="flex items-center justify-end gap-2">
                        <Link
                          to={`/dashboard/officer/edit/${item._id}`}
                          className="inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-semibold text-blue-600 bg-blue-50 hover:bg-blue-600 hover:text-white rounded-lg transition-all duration-200 border border-blue-100 hover:border-blue-600 hover:shadow-lg hover:shadow-red-500/20"
                        >
                          <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
